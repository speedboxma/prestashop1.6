...
class AdminSpeedboxOrdersModels
{
    ...
    /*public function SetDeliveryMode($id_order, $delivery_mode)
    {
        Db::getInstance()->execute('UPDATE ' . _DB_PREFIX_ . 'orders SET type_livraison = "' . pSQL($delivery_mode) . '" WHERE id_order = "' . $id_order . '"');
        Db::getInstance()->execute('UPDATE ' . _DB_PREFIX_ . 'order_carrier SET type_livraison = "' . pSQL($delivery_mode) . '" WHERE id_order = "' . $id_order . '"');
    }*/
