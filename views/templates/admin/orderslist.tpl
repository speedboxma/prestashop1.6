...
{if $order_info !== 'error'}
    <input id="tableFilter" value="{l s='Search something, separate values with ; ' mod='speedbox'}"/><img id="filtericon" src="../modules/speedbox/views/img/search.png"/><br/><br/>
        ...
        <body><table>
                <thead>
                    <tr>
                        ...
                        <th class="hpr">{l s='Destination' mod='speedbox'}</th>
                        <th class="hpr">{l s='Mode de livraison' mod='speedbox'}</th>
        ...
        {foreach from=$order_info item=order}
            <tr>
                ...
                <td class="pr">{$order.type_livraison|escape:'quotes':'UTF-8'}</td>
    ...
    <p>
        ...
        <!-- <input type="submit" class="button" name="back" value="{l s='Parcels back' mod='speedbox'}" /> --> 
    </p>
    </form></fieldset>
{else}
