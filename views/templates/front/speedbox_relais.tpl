...
<div id="speedbox_relais_container">
...
<tr class="speedbox_lignepr" onclick="document.getElementById('{$points.relay_id|escape:'htmlall':'UTF-8'}').checked=true">
        ...
        <td align="left" class="speedbox_adressepr"><b>{$points.shop_name|escape:'htmlall':'UTF-8'}</b><br/>{$points.address|escape:'htmlall':'UTF-8'}<br/>{$points.postcode|escape:'htmlall':'UTF-8'} {$points.city|escape:'htmlall':'UTF-8'}</td>
